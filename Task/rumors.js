<html><body><p>const valueRegex = /<a const="" data="" else="" error="" function="" href="..\/(.*?)" if="" match="data.match(valueRegex);" response="" rumorregex="/谣言：(.*?)&lt;\/strong" sourceurl="https://www.piyao.org.cn/jrpy/index.htm" targetcontenturl="targetUrl" targeturl="https://www.piyao.org.cn/" targetvalue="match[1];" useragent="Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/83.0.4103.116 Safari/537.36">&lt;\/span&gt;&lt;\/p&gt;/;
...
</strong></strong></span></p></strong></a></p></body></html>